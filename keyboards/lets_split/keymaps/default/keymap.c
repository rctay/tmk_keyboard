...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
        ...
        KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  , KC_GRV,     KC_RALT, KC_N  , KC_M  ,KC_COMM, KC_DOT,KC_SLSH,
                    //+--61---+-------+-------+-------+    +-------+-------+---63--+-------+
                    //+--6.3--+-------+-------+-------+    +-------+-------+--6.9--+-------+
	...
	[_RAISE] = LAYOUT(
       KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
       KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
       KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_TRNS,KC_LPRN,KC_LBRC,KC_LCBR,KC_INS ,KC_TRNS,
       KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_TRNS,KC_SLSH,KC_MINS,KC_EQL ,KC_BSLS,KC_TRNS,
